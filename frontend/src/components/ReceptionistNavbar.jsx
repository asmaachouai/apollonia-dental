    ...
    <nav className="bg-white border-b border-slate-100 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-base">R</div>
          <div>
            <span className="font-bold text-slate-800 text-base leading-tight block">Apollonia</span>
            <span className="text-xs text-slate-400 leading-tight block">Reception</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <NavLink to="/profile" className="text-right hidden sm:block hover:opacity-80 transition">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full font-medium bg-purple-100 text-purple-700">Receptionist</span>
          </NavLink>
